...
# rewrote this module and dropped the command while
# `utils/geotizer_service_account.py` kept every function it calls, and
# `docs/geotizer-service-account.md` kept telling an operator to run it.
